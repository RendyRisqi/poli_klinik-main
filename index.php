...
<head>
    ...
    <!-- Copyright: © 2024 Sistem Temu Janji Pasien - dibuat sebagai syarat sertifikasi oleh rendy -->
...
<body class="hold-transition login-page">
    <div class="container-fluid flex flex-col justify-center items-center text-dark p-5 home-page"
        ...
        <p>
            Rendy Risqi Pradana - A11.2021.13345
        </p>
    </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="text-content">
                                <h6>pradana</h6>
                                <p class="location">Brebes</p>
                                <p class="testimonial-text">web ini sangat membantu untuk masyarakat, terutama fitur-fitur yang mudah dipahami untuk user yang baru pertamakali, dan semoga kedepannya bisa berkembang lagi</p>
                            </div>
                        </div>
                    </div>
                </div>
